---
title: "(4) A Model for Newton's Law of Cooling"
author: "Dustin Kapraun"
date: "`r Sys.Date()`"
output: html_vignette
vignette: >
  %\VignetteIndexEntry{(4) A Model for Newton's Law of Cooling}
...
newt_cool_mod_name <- file.path(mod_path, "newt_cool")
...
Note that executing the command `newt_mod$updateParms(c(T0=95, Tamb=22, r=0.7))` updates the parameter values (replacing the default values that were provided in the model specification file) and that executing the command `newt_mod$updateY0()` updates the initial value of the state variable `T` using the updated value of the parameter `T0`.
