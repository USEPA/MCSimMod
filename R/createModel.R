...
#' @param verboseOutput Boolean specifying whether to write translator messages to standard output. If value is TRUE, messages will be written standard output; if value is FALSE, messages will be written to files in a temporary directory.
